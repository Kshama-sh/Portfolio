...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-slate-950 border-t border-slate-800/50 py-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-slate-800/50 border border-slate-700/50 rounded-lg flex items-center justify-center hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all"
              >
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-cyan-500 hover:bg-cyan-600 text-slate-900 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/30 hover:scale-110 transition-all duration-300 z-50"
